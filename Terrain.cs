/*  
    ...
    The file Terrain.cs is part of AGMGSKv8 a port and update of AGXNASKv7 from
...
public class Terrain : IndexVertexBuffers {
   ...
   public Terrain(Stage theStage, string label, string heightFile, string colorFile) 
      ...
      moon = stage.Content.Load<Texture2D>(colorFile);
      colorMap = 
         new Microsoft.Xna.Framework.Color[width * height];
      moon.GetData<Microsoft.Xna.Framework.Color>(colorMap);
